...
require("AdventureGame_BuildingCardChoiceByName")
GetAdventureGame_BuildingCardChoiceWindowUis = function(ui, ...)
  ...
  uis.BuildingCardChoiceGrp = GetAdventureGame_BuildingCardChoiceUis(ui:GetChild("BuildingCardChoiceGrp"))
  uis.root = ui
  return uis
end
