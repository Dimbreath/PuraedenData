...
require("Expedition_RewardShowByName")
GetExpedition_RewardShowWindowUis = function(ui, ...)
  ...
  uis.RewardShowGrp = GetExpedition_RewardShowUis(ui:GetChild("RewardShowGrp"))
  uis.root = ui
  return uis
end
