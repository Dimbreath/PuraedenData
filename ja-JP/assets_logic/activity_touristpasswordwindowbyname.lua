...
require("Activity_TouristPassWordByName")
GetActivity_TouristPassWordWindowUis = function(ui, ...)
  ...
  uis.TouristPassWord = GetActivity_TouristPassWordUis(ui:GetChild("TouristPassWord"))
  uis.root = ui
  return uis
end
