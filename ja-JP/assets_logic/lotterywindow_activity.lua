...
LotteryWindow_Activity = {}
local LotteryCardId = {single = 24000061, ten = 24000062, day = 24000063}
...
local lotteryType = LotteryType.HuoDongUp
...
LotteryWindow_Activity.RefreshWindow = function(_uis, ...)
...
LotteryWindow_Activity.ReceiveInitData = function(...)
  ...
  ;
  (LotteryWindow_Activity.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).OneTimeBtn, LotteryCardId.single, lData.onceFreeNum)
  ;
  (LotteryWindow_Activity.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).TenTimeBtn, LotteryCardId.ten, lData.moreFreeNum)
  ;
