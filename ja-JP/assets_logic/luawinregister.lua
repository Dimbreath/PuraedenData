...
, 
ClearingWindow = {E_MSG_REWARD_REFRESH = 1, E_MSG_PHYSICAL_REFRESH = 2}
, 
...
, 
ShopWindow = {E_MSG_REFRESH = 1, E_MSG_REFRESH_ITEM = 2, E_MSG_SET_TYPE = 3, E_MSG_GET_ACTIVITYINFO = 4, E_MSG_CLEAR_FREEGIFTREDDOT = 5}
, 
...
, 
HandBookAlbumWindow = {"HandBookCGBanner", "HandBookPlotBanner"}
, 
