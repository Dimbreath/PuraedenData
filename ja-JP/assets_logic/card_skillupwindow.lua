...
-- DECOMPILER ERROR at PC52: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.RefreshWindow = function(isInit, ...)
  -- function num : 0_1 , upvalues : skillsData, _ENV, cardData, skills
  skillsData = {}
...
-- DECOMPILER ERROR at PC55: Confused about usage of register: R30 in 'UnsetPending'
...
-- DECOMPILER ERROR at PC58: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.CreatPrefab = function(url, index, sData, ...)
  -- function num : 0_3 , upvalues : skillList, _ENV, skillPrefabs
...
-- DECOMPILER ERROR at PC61: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.SetPrefabInfo = function(obj, skill, _index, ...)
  -- function num : 0_4 , upvalues : _ENV, cardData, starUrl, growType, MAXSKILLLEVEL, isLongPress, enableClick, reqSkillID, selectSkillIndex, preData, isSingleClick, effectTimer, fakeLvl, fakeCanLvUpNum, fakeTotalCost, tips1IsTip, tips2IsTip, tips3IsTip, fakeTotalCoin, fakeCastCoin, afterData
  local uis = nil
  local index = _index
  ...
  (((uis.SkillFrameGrp).SkillLoader).onClick):Add(function(...)
    -- function num : 0_4_0 , upvalues : _ENV, skillData, skill, cardData
  ...
  if skillType == 2 then
              ...
              do
                do
                  ...
                  if tonumber(cost) <= selfGold then
                    isGoldEnough = true
                    -- DECOMPILER ERROR at PC314: Confused about usage of register: R12 in 'UnsetPending'

                    ;
                    (uis.Number_01_Txt).text = "[color=#3dffbd]" .. cost .. "[/color]"
                  else
                    isGoldEnough = false
                    -- DECOMPILER ERROR at PC322: Confused about usage of register: R12 in 'UnsetPending'
    ...
    -- function num : 0_4_1 , upvalues : isLongPress, enableClick, _ENV, index, skill, cardData, isGoldEnough, reqSkillID, selectSkillIndex, preData, isSingleClick, MAXSKILLLEVEL
    ...
    -- function num : 0_4_2 , upvalues : effectTimer, fakeLvl, skill, fakeCanLvUpNum, fakeTotalCost, tips1IsTip, tips2IsTip, tips3IsTip, selectSkillIndex, index, fakeTotalCoin, _ENV, fakeCastCoin, preData, isLongPress, cardData, MAXSKILLLEVEL, isGoldEnough, growType, uis
    ...
    effectTimer = (SimpleTimer.new)(0.18, -1, function(...)
      -- function num : 0_4_2_0 , upvalues : _ENV, uis
    ...
    -- function num : 0_4_3 , upvalues : skill, cardData, MAXSKILLLEVEL, isGoldEnough, fakeCanLvUpNum, _ENV, growType, fakeLvl, index, fakeTotalCoin, tips1IsTip, uis, tips2IsTip, tips3IsTip, effectTimer, afterData, preData, fakeTotalCost, fakeCastCoin
    if cardData.level <= skill.value then
      return 
    end
    if MAXSKILLLEVEL <= skill.value then
    ...
    -- function num : 0_4_4 , upvalues : effectTimer, _ENV, isLongPress, fakeLvl, skill, cardData
    if effectTimer ~= nil then
      effectTimer:stop()
      effectTimer = nil
    end
    ...
    (SimpleTimer.setTimeout)(0.01, function(...)
      -- function num : 0_4_4_0 , upvalues : isLongPress
      isLongPress = false
    end
)
...
-- DECOMPILER ERROR at PC64: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.OnClose = function(...)
  -- function num : 0_5 , upvalues : skillList, _ENV, skillPanel, skills, battleNumTxt, reqSkillID, skillPrefabs, enableClick
  skillList:RemoveChildrenToPool()
  ;
  (Card_SkillUpWindow.KillTimersPool)()
  ;
...
-- DECOMPILER ERROR at PC67: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.KillTimersPool = function(...)
  -- function num : 0_6 , upvalues : _ENV, timers
...
-- DECOMPILER ERROR at PC70: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.ResStageInfo = function(msg, ...)
  -- function num : 0_7 , upvalues : _ENV, cardData, battleNumTxt, isSingleClick, skillList, selectSkillIndex, afterData, reqSkillID, preData
...
-- DECOMPILER ERROR at PC73: Confused about usage of register: R30 in 'UnsetPending'
...
-- DECOMPILER ERROR at PC76: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.PlayNumEffects = function(uis, afterData, preData, ...)
  -- function num : 0_9 , upvalues : selectSkillIndex, isPlayingNumEffects, _ENV
...
-- DECOMPILER ERROR at PC79: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.PropertyNumberEffects = function(_uis, index, afterData, preData, ...)
  -- function num : 0_10 , upvalues : _ENV, isPlayingNumEffects
  ((_uis.DescribeTxt):TweenFade(0, 0.25)):OnComplete(function(...)
    -- function num : 0_10_0 , upvalues : _uis
...
-- DECOMPILER ERROR at PC82: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.NumberUpdate = function(_uis, index, afterData, preData, ...)
  -- function num : 0_11 , upvalues : _ENV, uniqueTable, isPlayingNumEffects
  local uis = GetCard_SkillLevelUpUis(_uis.SkillDescribeGrp)
  ...
  do
    ...
    -- function num : 0_11_0 , upvalues : uis, t, _ENV
    ...
    -- function num : 0_11_1 , upvalues : _ENV, _uis, isPlayingNumEffects, index, uniqueTable
    (SimpleTimer.setTimeout)(0.3, function(...)
      -- function num : 0_11_1_0 , upvalues : _uis, isPlayingNumEffects, index, uniqueTable
      -- DECOMPILER ERROR at PC1: Confused about usage of register: R0 in 'UnsetPending'
...
-- DECOMPILER ERROR at PC85: Confused about usage of register: R30 in 'UnsetPending'
...
-- DECOMPILER ERROR at PC88: Confused about usage of register: R30 in 'UnsetPending'

Card_SkillUpWindow.CancelAllLeanTween = function(...)
  -- function num : 0_13 , upvalues : _ENV, uniqueTable
