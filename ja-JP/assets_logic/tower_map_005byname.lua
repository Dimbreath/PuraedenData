...
GetTower_Map_005Uis = function(ui, ...)
  -- function num : 0_0 , upvalues : _ENV
  local uis = {}
  uis.Layer = GetTower_Layer_005Uis(ui:GetChild("Layer"))
  ...
  uis.Line_03 = GetTower_Line_3Uis(ui:GetChild("Line_03"))
