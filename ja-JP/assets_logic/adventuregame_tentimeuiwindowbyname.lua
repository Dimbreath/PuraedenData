...
require("AdventureGame_TenTimeUIByName")
GetAdventureGame_TenTimeUIWindowUis = function(ui, ...)
  ...
  uis.TenTimeUIGrp = GetAdventureGame_TenTimeUIUis(ui:GetChild("TenTimeUIGrp"))
  uis.root = ui
  return uis
end
