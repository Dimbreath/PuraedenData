...
options = {map_entry = true}
  ...
  local info = {name = name, number = (lex:expected("=")):integer(), label = labels.optional, type = type, type_name = type_name}
  ...
  -- function num : 0_35 , upvalues : _ENV, Parser
  local sub = {syntax = "proto2", 
locmap = {}
, prefix = ".", lex = lex, parent = self}
  sub.loaded = self.loaded
  sub.typemap = self.typemap
  sub.paths = self.paths
  sub.import_fallback = function(import_name, ...)
  ...
  sub.type_fallback = function(type_name, ...)
    -- function num : 0_35_1 , upvalues : self, _ENV
  ...
  -- function num : 0_37 , upvalues : default
  ...
  -- function num : 0_39 , upvalues : default, toplevel
  ...
  -- function num : 0_40 , upvalues : default, toplevel, _ENV
  ...
  -- function num : 0_41 , upvalues : default, _ENV
  ...
  -- function num : 0_42 , upvalues : default
  if lex:test("%a") then
  ...
  -- function num : 0_43 , upvalues : default, toplevel, field
  ...
  -- function num : 0_44 , upvalues : register_type, types, msg_body, default, label_field
  ...
  -- function num : 0_45 , upvalues : register_type, types, toplevel, default, inline_option
  ...
  -- function num : 0_46 , upvalues : default
  ...
  -- function num : 0_47 , upvalues : default, label_field
  ...
  -- function num : 0_48 , upvalues : type_info, toplevel, default
  ...
  -- function num : 0_50 , upvalues : svr_body, default
  ...
  -- function num : 0_51 , upvalues : _ENV, Lexer, make_subparser, toplevel
  if not name then
    name = "<input>"
  end
  ...
  -- function num : 0_58 , upvalues : iter, check_dup, check_field
  ...
  -- function num : 0_60 , upvalues : iter, check_message, check_enum, check_service, check_field
...
file = {f(...)}
  ...
  -- function num : 0_63 , upvalues : do_compile, _ENV, pb
  ...
  -- function num : 0_64 , upvalues : do_compile, _ENV, pb
