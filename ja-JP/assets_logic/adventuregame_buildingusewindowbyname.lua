...
require("AdventureGame_BuildingUseByName")
GetAdventureGame_BuildingUseWindowUis = function(ui, ...)
  ...
  uis.BuildingUseGrp = GetAdventureGame_BuildingUseUis(ui:GetChild("BuildingUseGrp"))
  uis.root = ui
  return uis
end
